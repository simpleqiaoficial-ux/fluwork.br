...
export const notasFiscais = pgTable("notas_fiscais", {
  ...
  // Nullable: o fluxo real de anexo manual (marcarNotaEmitida) não coleta número da nota no
  // upload, só o arquivo — quem confere/preenche isso é o financeiro na aprovação.
