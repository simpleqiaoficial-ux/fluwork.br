    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid gap-x-4 gap-y-5 sm:grid-cols-2">
          ...
          <div className="space-y-2 sm:col-span-2">
            <Label htmlFor="link_emissao_manual">Link de emissão de nota fiscal</Label>
            <Input
              id="link_emissao_manual"
              placeholder="https://www.nfse.gov.br/EmissorNacional/Login"
              value={form.link_emissao_manual}
              onChange={(e) => setForm({ ...form, link_emissao_manual: e.target.value })}
            />
            <p className="text-xs text-muted-foreground">
              Pra onde o botão "Emitir nota fiscal" leva o prestador. Se não configurado, usa o Emissor Nacional de NFS-e do governo.
            </p>
          </div>
        </CardContent>
      </Card>
