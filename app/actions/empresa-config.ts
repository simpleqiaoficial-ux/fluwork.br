...
/** Link de emissão manual de NFS-e configurado pela empresa do usuário logado, se houver —
 *  usado no botão "Emitir nota fiscal" da tela de pagamentos do prestador. */
