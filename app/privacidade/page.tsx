  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-16 pb-10 text-center border-b">
        ...
        <p className="text-sm text-muted-foreground mt-2">FluxoPay - LGPD (Lei n 13.709/2018)</p>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-10">
        ...
        <section>
          ...
          <div className="border-l-2 border-destructive pl-4 py-1">
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground font-medium">Proibido:</strong> O FluxoPay jamais vende, cede ou comercializa dados pessoais para terceiros
